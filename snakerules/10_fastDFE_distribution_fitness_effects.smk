...
rule angsd_for_DFE_4fold:
  input:
    ...
    indF="results/ngsF_HMM/hap2/by_popln/{population}_minInd{minInd_prop}_ngsF-HMM_inbreeding.indF"
  output:
    arg_file="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites.arg",
    mafs_file="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites.mafs.gz",
    saf_1="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites.saf.idx",
    saf_2="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites.saf.pos.gz",
    saf_3="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites.saf.gz",
    glf_file="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites.glf.gz"
  params:
    ref="data/reference/hap2/lupinehap2.fasta",
    file_name="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_4fold_sites",
  ...
  log:
    "results/logs/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/angsd_4fold_sites_hap2_{population}_minInd{minInd_prop}.log"
  envmodules:
    "angsd/0.940"
  threads: 8
  shell:
...
rule angsd_for_DFE_CDS:
  input:
    ...
    indF="results/ngsF_HMM/hap2/by_popln/{population}_minInd{minInd_prop}_ngsF-HMM_inbreeding.indF"
  output:
    arg_file="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.arg",
    mafs_file="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.mafs.gz",
    saf_1="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.saf.idx",
    saf_2="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.saf.pos.gz",
    saf_3="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.saf.gz",
    glf_file="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.glf.gz"
  params:
    ref="data/reference/hap2/lupinehap2.fasta",
    file_name="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites",
    scaffolds="results/scaffolds/hap2_scaffolds.txt",
    minInd=lambda wildcards, input: max(1, int(float(wildcards.minInd_prop) * sum(1 for _ in open(input.bam_list)))),
    minDepth=lambda wildcards: get_depth_bounds(wildcards.population)[0],
    maxDepth=lambda wildcards: get_depth_bounds(wildcards.population)[1]
  log:
    "results/logs/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/angsd_CDS_other_hap2_{population}_minInd{minInd_prop}.log"
  envmodules:
    "angsd/0.940"
  threads: 8
  shell:
...
rule SFS_4fold_by_population:
  input:
    saf_idx="results/angsd/hap2/canonical/DFE/by_popln/{population}_minInd{minInd_prop}_4fold_sites.saf.idx",
    canonical_sites="results/bed/hap2/DFE_sites/{population}_4D_filtered.txt",
    ref="data/reference/hap2/lupinehap2.fasta"
  output:
    sfs="results/realSFS/hap2/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_DFE_folded_4fold.sfs"
  log:
    "results/logs/realSFS/hap2/DFE/by_popln_minInd{minInd_prop}/{population}_DFE_folded_4fold_minInd{minInd_prop}.log"
  envmodules:
    "angsd/0.940"
  threads: 40
  shell:
...
rule SFS_CDSother_by_population:
  input:
    saf_idx="results/angsd/hap2/canonical/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_CDS_other_sites.saf.idx",
    canonical_sites="results/bed/hap2/DFE_sites/{population}_CDS_other_filtered.txt",
    ref="data/reference/hap2/lupinehap2.fasta"
  output:
    sfs="results/realSFS/hap2/DFE/by_popln_minInd{minInd_prop}/{population}_DFE_folded_CDS_minInd{minInd_prop}.sfs"
  log:
    "results/logs/realSFS/hap2/DFE/by_popln_minInd{minInd_prop}/{population}_DFE_folded_CDS_minInd{minInd_prop}.log"
  envmodules:
    "angsd/0.940"
  threads: 40
  shell:
...
rule fastdfe_by_population:
  input:
    neut = "results/realSFS/hap2/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_DFE_folded_4fold.sfs",
    sel  = "results/realSFS/hap2/DFE/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_DFE_folded_CDS.sfs"
  output:
    # keep your original expected artifacts
    png   = "results/plots/hap2/fastdfe/{population}_minInd{minInd_prop}_fastdfe_plot.png",
    csv   = "results/fastdfe/hap2/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_fastdfe_discretized.csv",
    json  = "results/fastdfe/hap2/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_fastdfe_inference.json",
    txt   = "results/fastdfe/hap2/by_popln_minInd{minInd_prop}/{population}_minInd{minInd_prop}_fastdfe_summary.txt"
  log:
  ...
  threads: 2
  params:
    outdir           = "results/fastdfe/hap2/by_popln_minInd{minInd_prop}",
    plots_dir        = "results/plots/hap2/fastdfe",
    n_runs           = 100,
    models           = "all",           # options: gammaexp,discrete,gammadiscrete,displacedgamma or 'all'
    bootstrap        = "TRUE",          # "TRUE" or "FALSE"
    ci_level         = 0.05,            # alpha; 0.05 -> 95% CI
    bootstrap_type   = "percentile",    # or "bca"
    fix_beneficial   = "TRUE",          # fix p_b=0, S_b=1, eps=0 for folded SFS
    py               = "~/envs/fastdfe-py312/bin/python",
    Rscript          = "scripts/fastdfe_multi.R"     # <- your upgraded script filename
  shell:
    r"""
    set -euo pipefail

    mkdir -p "$(dirname {log})" "{params.outdir}" "{params.plots_dir}"

    # We encode minInd into the pop string so the script's outputs inherit it.
    POPSTR="{wildcards.population}_minInd{wildcards.minInd_prop}"

    # Run the multi-model fastDFE script
    MPLBACKEND=Agg \
    PYTHONNOUSERSITE=1 \
    ...
    Rscript --vanilla {params.Rscript} \
      ...
      --fix_beneficial_for_folded {params.fix_beneficial} \
      > "{log}" 2>&1

    # The script writes:
    #   {outdir}/{POP}_fastdfe_models_plot.png
    #   {outdir}/{POP}_fastdfe_discretized_models.csv
    #   {outdir}/{POP}_fastdfe_inference.json
    #   {outdir}/{POP}_fastdfe_summary.txt
    # Rename/move to match this rule's outputs.

    SRC_PNG="{params.outdir}/${{POPSTR}}_fastdfe_models_plot.png"
    SRC_CSV="{params.outdir}/${{POPSTR}}_fastdfe_discretized_models.csv"
    SRC_JSON="{params.outdir}/${{POPSTR}}_fastdfe_inference.json"
    SRC_TXT="{params.outdir}/${{POPSTR}}_fastdfe_summary.txt"

    # ensure sources exist (fail early with a clear message if not)
    test -s "$SRC_PNG"  || (echo "Missing PNG: $SRC_PNG"  >> "{log}" && exit 1)
    test -s "$SRC_CSV"  || (echo "Missing CSV: $SRC_CSV"  >> "{log}" && exit 1)
    test -s "$SRC_JSON" || (echo "Missing JSON: $SRC_JSON" >> "{log}" && exit 1)
    test -s "$SRC_TXT"  || (echo "Missing TXT: $SRC_TXT"  >> "{log}" && exit 1)

    # Move/rename to final targets
    cp "$SRC_PNG"  "{output.png}"
    cp "$SRC_CSV"  "{output.csv}"
    cp "$SRC_JSON" "{output.json}"
    cp "$SRC_TXT"  "{output.txt}"
    """
